...
- For exact recall use ONLY the retrieval contract (never raw SQL; the backend is swappable):
  python3 "/Users/danielpuri/Desktop/Super Project/tools/corpus_search.py" "<query>" --k 20 [--since YYYY-MM-DD] [--who me|them]
...
Fallback for exact-date or narrow-window queries:
  grep '"YYYY-MM-DD' /Users/danielpuri/twin-corpus/normalized/imessage.jsonl | head -N
  grep '"YYYY-MM-DD' /Users/danielpuri/twin-corpus/normalized/transcripts.jsonl | head -N
