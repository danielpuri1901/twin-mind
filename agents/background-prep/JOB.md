...
4. **Shadow week**: dossiers delivered with [SHADOW] prefix, Daniel verdicts them (good|bad + notes) exactly like brief verdicts -> feedback.jsonl -> first labeled dataset (`prep-labels.jsonl`).
